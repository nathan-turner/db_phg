...
foreach($arr as $key=>$row)
{
	...
	*/
	...
	if(!$bad){
		...
		//$sql = "EXEC AddImportPhys2 $cname,'MD',$cphone,NULL,NULL,NULL,NULL,NULL, $cemail,NULL,NULL, $caddrc,$caddrz,$cstate, $cspec,NULL,0,0,'---', $clic,NULL,$ideal,$src_date,'" . $Session->{"UserName"} . "','$ctme','$csub','$csubspec',$cskill,$note";
