...
$docx = new CreateDocx();
$html = '<p>This is some HTML code to be included in the footnote with a link to <a href="http://www.2mdc.com">2mdc.com</a> and a random image: <img src="image.jpg" width="35px" height="35px" style="vertical-align: -25px"></p>';
